...
import { setEmployeeStats, setEmployeeLoading } from './dashboardSlice';
import { toast } from 'react-toastify';
import {
  BarChart3, Loader2, Calendar, CheckCircle, Clock, PieChart, FileText, RefreshCcw
} from 'lucide-react';

export default function EmployeeDashboard() {
  const dispatch = useDispatch();

  const { stats: reduxStats, loading, isCached } = useSelector((state) => state.dashboard.employee);
  const stats = {
    attendanceCount: 0,
    averageHours: 0,
    leavesApplied: 0,
